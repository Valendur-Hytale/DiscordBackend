...
async function getAllByUser(userID) {
    return await Obj.find({user: userID}).populate('risks').populate('refBInterf').populate('refGInterf').populate('refTechno').populate('refTechno2').select('-user');
}
