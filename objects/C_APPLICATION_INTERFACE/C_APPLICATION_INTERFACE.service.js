...
const Obj = db.C_APPLICATION_INTERFACE;
...
return await Obj.find({user: userID}).populate('RC_ASSOCIATED_VIEWS').populate('RC_IS_APPLICATION_OWNER').populate('RC_ACCOUNTABLE_PERSON').populate('RC_CONSULTED_PERSON').populate('RC_INFORMED_PERSON').populate('RC_REALIZATION').populate('RC_ASSIGNMENT').populate('RC_AGGREGATION').populate('RC_COMPOSITION').populate('RC_INFLUENCE').populate('RC_ACCESS').populate('RC_SERVING').populate('RC_TRIGGERING').populate('RC_FLOW').populate('RC_SPECIALIZATION').populate('RC_ASSOCIATION').populate('RC_PREDECESSOR_OBJECT').select('-user');
}
